...
class TransactionController extends Controller
{
    ...
    public function storeTransaction(Request $request)
    {
        ...
        return redirect()->route('showAllTransaction')->with('success', 'Transaction created successfully.');
    }
    ...
    public function deleteTransaction(Request $request)
    {
        ...
        return redirect()->route('showAllTransaction', ['id' => $transaction->id])->with('success', 'Transaction deleted successfully.');
